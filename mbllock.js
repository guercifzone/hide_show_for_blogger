 ...
 */
 ...
 $('#mblunlocker').html('Powered By <a href="http://www.mybloggerlab.com">MyBloggerLab.com</a>');
...
(function ($) {
    ...
    */
    $.onepress.tools.has3d = $.onepress.tools.has3d || function has3d() {
    ...
    $.onepress.widget("twitterButton", {
        ...
        */
        _createButton: function () {
            ...
            if (this.options.url) this.button.attr("data-url", this.options.url);
...
(function ($) {
    ...
    */
    $.onepress.providers.clientStoreStateProvider = function (postfix, url, demo) {
    ...
    $.onepress.widget("socialLock", {
        ...
        */
        _create: function () {
            ...
            if (!this.options.locker.mobile && this._isMobile()) this._unlock("mobile");
        ...
        */
        _createProviderController: function () {
            ...
            for (var providerIndex in this.options.buttons.order) {
                ...
                this._providers[sourceName] = new $.onepress.providers.clientStoreStateProvider(sourceName, url, self.options.demo);
                totalCount++;
            }
        ...
        */
        _processOptions: function () {
            ...
            if (options.style && $.onepress.presets[options.style]) {
                options = $.extend(true, {}, options, $.onepress.presets[options.style]);

                if ($.onepress.presets[options.style].buttons && $.onepress.presets[options.style].buttons.order) {
                    options.buttons.order = $.onepress.presets[options.style].buttons.order;
                }
            }
        ...
        */
        _createButtonMarkup: function () {
            ...
            for (var index in this.options.buttons.order) {
                ...
                var flipEffect = this.options.effects.flip && $.onepress.tools.has3d();

                // addes the flip effect
                (flipEffect && button.addClass("ui-social-locker-flip")) || button.addClass("ui-social-locker-no-flip");
        ...
        _createTimer: function () {
            ...
            this.timerCounter = $("<span class='ui-social-locker-timer-counter'>" + this.options.locker.timer + "s</span>").appendTo(this.timer);
